...
var Select = React.createClass({
    ...
    propTypes: {
        ...
        onClickWhenDisable: React.PropTypes.func, // onClick handler, only when disabled: function(event) {}
        ...
        if (this.props.filterOptions) {
            ...
            var filterOption = function filterOption(op) {
                ...
                var valueTest = String(op.value),
                    labelTest = String(op.text);
                if (this.props.ignoreCase) {
                    valueTest = valueTest.toLowerCase();
                    labelTest = labelTest.toLowerCase();
                    filterValue = filterValue.toLowerCase();
                }
                return !filterValue || this.props.matchPos === 'start' ? this.props.matchProp !== 'text' && valueTest.substr(0, filterValue.length) === filterValue || this.props.matchProp !== 'value' && labelTest.substr(0, filterValue.length) === filterValue : this.props.matchProp !== 'text' && valueTest.indexOf(filterValue) >= 0 || this.props.matchProp !== 'value' && labelTest.indexOf(filterValue) >= 0;
            };
    ...
    buildMenu: function buildMenu() {
        ...
        var ops = Object.keys(this.state.filteredOptions).map(function (key) {
            ...
            return op.disabled ? React.createElement(
                ...
                'div',
                { ref: ref, key: 'option-' + op.value, className: optionClass, onMouseEnter: mouseEnter,
                    onMouseLeave: mouseLeave, onMouseDown: mouseDown,
                    onClick: mouseDown },
                op.create ? this.props.addLabelText.replace('{text}', op.text) : renderedLabel
            );
        }, this);
